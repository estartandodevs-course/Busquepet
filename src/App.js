...
function App() {
	...
	return (
		<div className="App">
			{/* <DonorRegister /> */}
			{/* <LocationData/> */}
			<PetDetail dogImage={Melzinha} description="A Melzinha foi encontrada próximo à minha casa, porém não tenho condinções de cuidar dela, já tenho animais em casa. Ela é muito dócil e se adapta muito rápido ao ambiente.. Lorem ipsum Lorem ipsum Lorem Ipsum."></PetDetail> 
			{/* <Routes /> */}
			 {/* <Button name="Fazer" identifier="green"></Button> */}
			{/*<Select type="estado" /> */}
