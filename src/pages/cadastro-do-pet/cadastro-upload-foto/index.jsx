...
export default function DetailUrl(){
    return (
        <>
            ...
            <div className="text-instruction">
                ...
                <span className="title-instruction">Passo 02: </span><span>Ao escolher a foto, você clicar nos três pontinhos ao lado (   );</span><br></br>
